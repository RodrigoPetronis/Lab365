...
const listaDuplicados = ["Pedro", "José", "Aderbal", "Danilo", "Luisa", "Vitoria", "Luis", "Danilo", "José"]

let listaNova=[]
let excluidos=[]

 //const set1 = new Set(listaDuplicados)  O metodo Set cria um objeto com itens únicos



listaDuplicados.forEach((e)=>{
    if(!listaNova.includes(e)){
        listaNova.push(e)
    }else{
        excluidos.push(e)
    }
